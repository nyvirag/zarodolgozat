...
export default function ImagePickerExample() {
  ...
  return (
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: "#c38eb4" }}>
...
<Text style={{padding: 10}}>
      ...
      <TextInput
        style={{height: 40, margin:5, backgroundColor:"lightpink", borderRadius:10}}
        placeholder="adj nevet a képnek"
